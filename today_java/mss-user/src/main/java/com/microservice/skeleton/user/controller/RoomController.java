...
@Tag(name = "教室管理", description = "教室的增删改查及可用性查询")
@RestController
...
public class RoomController {
    ...
    public ApiResponse<RoomResponse> updateRoom(
            @Parameter(description = "教室ID") @PathVariable Integer id,
    ...
    public ApiResponse<Void> deleteRoom(@Parameter(description = "教室ID") @PathVariable Integer id) {
    ...
    public ApiResponse<RoomResponse> getRoom(@Parameter(description = "教室ID") @PathVariable Long id) {
    ...
    @GetMapping("/page")
    @Operation(summary = "分页获取教室列表")
    public ApiResponse<PageResult<RoomResponse>> getAllRooms(
    ...
    public ApiResponse<List<RoomResponse>> getRoomsByCommunity(
            @Parameter(description = "社区ID") @PathVariable Integer communityId) {
