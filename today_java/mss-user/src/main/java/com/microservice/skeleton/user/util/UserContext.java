...
//
//    private static final ThreadLocal<WeChatUserInfo> USER_CONTEXT = new ThreadLocal<>();
//
//    /**
//     * 设置当前用户信息
//     */
//    public static void setCurrentUser(WeChatUserInfo userInfo) {
...
//        WeChatUserInfo userInfo = getCurrentUser();
